...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div>
            <table>
                <tr>
                    <td>
                        <asp:GridView ID="UserData" runat="server" DataKeyNames="UserID" AutoGenerateColumns="False" AutoGenerateDeleteButton ="True" AutoGenerateEditButton="true" OnRowDeleting="UserGrid_RowDeleting" OnRowEditing="UserGrid_RowEditing" OnRowCancelingEdit="UserGrid_RowCancelingEdit" OnRowUpdating="UserGrid_RowUpdating">
                            <Columns>
